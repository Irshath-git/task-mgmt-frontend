...
export default function Header() {
  ...
  const handleLogout = async () => {
    try {
      await axios.post(
        'https://task-mgmt-backend-1-bh32.onrender.com/api/users/',
      );
      router.push('/login');
    ...
    <header className="flex items-center h-16 px-4 border-b shrink-0 md:px-6 justify-between">
      ...
      >
        <span className="w-8 h-8 border bg-accent rounded-full">
          <img src="https://42f2671d685f51e10fc6-b9fcecea3e50b3b59bdc28dead054ebc.ssl.cf5.rackcdn.com/illustrations/undraw_apps_bqvc_(1)_6le4.svg" />
        </span>
        <span>Task Crew</span>
      </Link>
